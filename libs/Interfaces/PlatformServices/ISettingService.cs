...
namespace Interfaces.PlatformServices
{
    public interface ISettingService
    {
        ...
        /// <summary>Removes a desired key from the settings</summary>
        /// <param name="key">Key for setting</param>
        /// <param name="fileName">Name of file for settings to be stored and retrieved </param>
        void Remove(string key, string fileName = null);

        /// <summary>Clear all keys from settings</summary>
        /// <param name="fileName">Name of file for settings to be stored and retrieved </param>
        void Clear(string fileName = null);

        /// <summary>Checks to see if the key has been added.</summary>
